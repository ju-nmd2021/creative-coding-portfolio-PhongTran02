...
function setup() {
  ...
  background(200);
  angleMode(DEGREES);
  let color1 = color(hexToRgb("#58A79E").r, hexToRgb("#58A79E").g, hexToRgb("#58A79E").b);
  let color2 = color(hexToRgb("#A79E58").r, hexToRgb("#A79E58").g, hexToRgb("#A79E58").b);
  let color3 = color(hexToRgb("#9E58A7").r, hexToRgb("#9E58A7").g, hexToRgb("#9E58A7").b);
